#!/usr/bin/env python3
"""Generate reviewer-facing vector figures from the compact analysis."""
...
ANALYSIS = ROOT / "reports" / "compact_b_analysis.json"
...
def make_pareto(data: dict) -> Path:
    ...
    # Keep the plot readable at full text width without excessive whitespace.
...
def make_forest(data: dict) -> Path:
    ...
    # Six contrasts remain comfortably separated at this height.
